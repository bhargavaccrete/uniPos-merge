...
class OnlineCompletedDesktop extends StatefulWidget {
  const OnlineCompletedDesktop({super.key});

  @override
  State<OnlineCompletedDesktop> createState() => _OnlineCompletedDesktopState();
}

class _OnlineCompletedDesktopState extends State<OnlineCompletedDesktop> {

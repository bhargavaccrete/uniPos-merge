  ...
  Future<ImportResult> importData(Map<String, List<List<dynamic>>> allSheets) async {
    ...
    try {
      ...
      try {
        ...
        print('✅ Categories loaded: ${_categoryStore.categories.length}');
      } catch (e) {
      ...
      try {
        ...
        print('✅ Choices loaded: ${_choiceStore.choices.length}');
      } catch (e) {
      ...
      try {
        ...
        print('✅ Extras loaded: ${_extraStore.extras.length}');
      } catch (e) {
      ...
      try {
        ...
        print('✅ Items loaded: ${_itemStore.items.length}');
      } catch (e) {

...
mixin _$CategoryStore on _CategoryStore, Store {
  ...
  List<Category> get filteredCategories => (_$filteredCategoriesComputed ??=
      ...
      .value;
  Computed<int>? _$totalCategoryCountComputed;

  @override
  int get totalCategoryCount => (_$totalCategoryCountComputed ??= Computed<int>(
          () => super.totalCategoryCount,
          name: '_CategoryStore.totalCategoryCount'))
      .value;
  ...
  Category? get selectedCategory => (_$selectedCategoryComputed ??=
          Computed<Category?>(() => super.selectedCategory,
              name: '_CategoryStore.selectedCategory'))
      .value;
  ...
  late final _$selectedCategoryIdAtom =
      Atom(name: '_CategoryStore.selectedCategoryId', context: context);
  ...
  void clearSelection() {
    final _$actionInfo = _$_CategoryStoreActionController.startAction(
        name: '_CategoryStore.clearSelection');
    try {

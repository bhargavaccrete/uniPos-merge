...
mixin _$VariantStore on _VariantStore, Store {
  Computed<int>? _$variantCountComputed;

  @override
  int get variantCount =>
      (_$variantCountComputed ??= Computed<int>(() => super.variantCount,
              name: '_VariantStore.variantCount'))
          .value;
  ...
  @override
  Future<void> addVariant(VariantModel variant) {
  ...
  @override
  Future<void> updateVariant(VariantModel variant) {
